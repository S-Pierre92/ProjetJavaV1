				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="brand-wrap">
							<img class="logo" src="../assets/images/logoV3.png" width="auto">
						</div> <!-- brand-wrap.// -->
						</div>
						<div class="col-lg-4 col-xl-6 col-sm-8">
								<form action="#" class="search-wrap">
									...
									<span class="nav-wish">Je souhaite acheter</span>	 
											...
											<input type="text" class="form-control-lg" style="width:35%;" placeholder="BMW, Volkswagen, 308, ...">
								...
								<div class="widgets-wrap float-right">
									<a href="#" class="widget-header mr-3">
										<div class="icontext">
											...
											<div class="text-wrap">
													<span class="small badge badge-danger">3</span>
									...
									<div class="widget-header dropdown">
										<a href="#" data-toggle="dropdown" data-offset="20,10">
											<div class="icontext">
												...
												<div class="text-wrap">
													<div style="color:#000;">Mon compte <i class="fa fa-caret-down"></i> </div>
												</div>
											</div>
										</a>
										<div class="dropdown-menu dropdown-menu-right">
											<form class="px-4 py-3">
												<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal-sign">Mes informations</a>
												<hr class="dropdown-divider">
												<a class="dropdown-item btn btn-primary btn-block" href="#" data-toggle="modal" data-target="#modal-sign">Vendre</a>
										</div> <!--  dropdown-menu .// -->
									</div>  <!-- widget-header .// -->
								</div> <!-- widgets-wrap.// -->
							</div> <!-- col.// -->
	  ...
	  <div class=" container">
		  <div class="row">
				...
				<div class="col-12 col-md-4 text-center">
					<h4> Notre horaire</h4>
					Lun:	9h00-12h00 13h30-18h00<br>
					Mar:	9h00-12h00 13h30-18h00<br>
					Mer:	9h00-12h00 13h30-18h00<br>
					Jeu:	9h00-12h00 13h30-18h00<br>
					Ven:	9h00-12h00 13h30-18h00<br>
					Sam:	9h00-18h00<br>
					Dim:	Fermé
				</div>
				<div class="col-12 col-md-4 ">
