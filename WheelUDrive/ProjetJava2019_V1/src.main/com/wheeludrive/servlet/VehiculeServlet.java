...
public class VehiculeServlet extends AbstractWheelUDriveServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, NumberFormatException {
		...
		if (sendMail != null) {
			...
			try {
				// pour pouvoir r�cup�rer l'html g�n�r� depuis du jsp ,et le convertir en pdf
...
//			log.info(modele);
	...
	private void generateCommand(HttpServletRequest request) throws NumberFormatException, PropertyException {
		...
		Voiture car = VoitureManager.findVoiture(Integer.parseInt(request.getParameter(ID_VOITURE)));
